...
for i in range(0, 20):
    ...
    ridge = LassoCV(eps=0.01, alphas=alphas, fit_intercept=True, normalize=True, cv=kfold, n_jobs=-1)
...
test_output.to_csv("test_out_sklearn_cv-10-fold_lassocv.csv", sep=',', index=False)
